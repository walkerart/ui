...
(function ($, fluid) {
    ...
    function updateAuthoritatively(that, termRecord) {
        ...
        // WAC handle injected values into an autocomplete field
        if(that.hiddenInput.attr("overridden")){
            // remove temporary attribute
            that.hiddenInput.removeAttr("overridden")
            // rewrite termRecord values with the new ones
            termRecord.displayName = that.autocompleteInput.val();
            termRecord.urn = that.hiddenInput.val();
        }
